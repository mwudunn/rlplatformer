...
from QLearning.infrastructure.atari_wrappers import wrap_deepmind
...
def get_env_kwargs(env_name):
    ...
    elif env_name == 'Platformer-v0':
        def platformer_empty_wrapper(env):
            return env
        kwargs = {
...
def platformer_exploration_schedule(num_timesteps):
    return PiecewiseSchedule(
        [
            (0, 1),
            (num_timesteps * 0.1, 0.02),
